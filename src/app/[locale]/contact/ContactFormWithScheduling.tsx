          ...
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setShowScheduling(checked === "indeterminate" ? false : checked)
              }
            />
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    ...
                    <button
                      ...
                      className={`px-3 py-2 text-sm border rounded transition-colors ${
                        selectedSlot === "aug12-620"
                          ? "border-black bg-primary font-semibold text-white"
                    ...
                    <button
                      ...
                      className={`px-3 py-2 text-sm border rounded transition-colors ${
                        selectedSlot === "aug12-640"
                          ? "border-black bg-primary text-black font-semibold"
                          : "border-gray-800 text-black hover:bg-gray-100"
                      }`}
                    >
                      6:40 PM
