...
const CONTACT_INFO_DEFAULTS: CmsContactInfoContent = {
  locales: {
    en: {
      ...
      location: "Utah, US",
      emailTitle: "Email",
      emailSubtitle: "Contact us by email, and we will respond shortly.",
      phoneTitle: "Phone",
      phoneSubtitle: "Call us on weekdays after 6pm.",
      locationTitle: "Location",
      locationSubtitle: "Visit our studio by appointment.",
      socialLinks: [],
    },
    es: {
      title: "Contáctanos",
