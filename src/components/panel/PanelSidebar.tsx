...
import { LayoutDashboard, FileText, Settings, Calendar, LogOut, User, Users, ArrowLeft } from "lucide-react";
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-gray-200 shadow-sm">
      ...
      <div className="border-b border-gray-100">
        <Link
          href="/"
          className="flex items-center px-6 py-3 text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-50 transition-colors duration-200"
        >
